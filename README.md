...
新增浏览器工作台、Python 后端、官方目录刷新和独立购买助手。默认香港地区、日本优先；支持 Windows 便携打包。请阅读 [新版使用说明](monitor/README.md)、[来源与方法对比](SOURCES.md) 和 [验证记录](VALIDATION.md)。下方为原 Go 桌面版文档，新版从 `monitor/app.py` 启动。
